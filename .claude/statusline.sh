...
# 브랜드 로고 락업: ◆ WKND(골드) MOOD(화이트) + 정보
printf '\033[1;38;5;220m◆ WKND\033[0m\033[1;37m MOOD\033[0m \033[2m│\033[0m \033[38;5;245m%s\033[0m \033[2m│\033[0m \033[38;5;245m%s\033[0m' "${MODEL//·/ }" "$DIR"
